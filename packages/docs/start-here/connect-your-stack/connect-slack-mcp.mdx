...
In OpenWork, open your workspace and go to `Settings` > `Library`, expand `Advanced settings`, and click `Add workspace MCP`.

<Frame>
  ![OpenWork Library page listing skills, apps, and connections](/images/library-slack-connection.png)
</Frame>
