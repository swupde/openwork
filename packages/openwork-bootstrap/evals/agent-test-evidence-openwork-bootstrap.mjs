// Live E2E test evidence for the script-installable OpenWork bootstrap CLI.
//
...
//   DEN_API_E2E_BASE_URL=... pnpm exec node evals/agent-test-evidence-openwork-bootstrap.mjs
...
<title>OpenWork Bootstrap CLI — live E2E test evidence</title>
