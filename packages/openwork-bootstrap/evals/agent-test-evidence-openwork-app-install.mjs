// Live local E2E test evidence for `openwork install app` using a real macOS DMG.
//
...
if (process.platform !== "darwin") {
  throw new Error("openwork install app DMG test evidence requires macOS")
}
...
<title>OpenWork App DMG Install — test evidence</title>
...
</head><body><main><h1>OpenWork App DMG Install — test evidence</h1><div class="meta">Result: <code>${allOk ? "passed" : "failed"}</code> · Screenshots: ${frames.length}</div>
