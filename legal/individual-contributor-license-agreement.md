...
license granted herein to Different AI, Inc. and recipients of software
distributed by Different AI, Inc., You reserve all right, title, and interest
...
1. **Definitions.**
   ...
   Different AI, Inc. For legal entities, the entity making a Contribution
   ...
   submitted by You to Different AI, Inc. for inclusion in, or documentation
   of, any of the products owned or managed by Different AI, Inc. (the
   "Work"). For the purposes of this definition, "submitted" means any form
   of electronic, verbal, or written communication sent to Different AI, Inc.
   or its representatives, including but not limited to communication on
   electronic mailing lists, source code control systems, and issue tracking
   systems that are managed by, or on behalf of, Different AI, Inc. for the
...
2. **Grant of Copyright License.**
   ...
   Different AI, Inc. and to recipients of software distributed by
   Different AI, Inc. a perpetual, worldwide, non-exclusive, no-charge,
...
3. **Grant of Patent License.**
   ...
   employer has waived such rights for your Contributions to
   Different AI, Inc., or that your employer has executed a separate
   Corporate CLA with Different AI, Inc.
...
4. **Contributions.**
   ...
   submit it to Different AI, Inc. separately from any Contribution,
...
You agree to notify Different AI, Inc. of any facts or circumstances of which
you become aware that would make these representations inaccurate in any
respect.

---

This text is adapted from the individual contributor license agreement
published by the Google Open Source Programs Office and used by GitLab Inc.,
licensed under the
